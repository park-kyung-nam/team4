...
@Controller
public class AdminProdcateCont {
  @Autowired
  ...
  public AdminProdcateCont() {
    System.out.println("--> ProdcateCont created.");
  }

  // http://localhost:9090/ojt/admin/prodcate/create.do
  // http://localhost:9090/ojt/admin/prodcate/create.do?prodcategrpno=1
  @RequestMapping(value = "/admin/prodcate/create.do", method = RequestMethod.GET)
  public ModelAndView create(int prodcategrpno) {
    ...
    mav.setViewName("/admin/prodcate/create"); // /webapp/admin/prodcate/create.jsp

    return mav;
  }

  // prodcateVO는 Form 태그의 값으로 자동 저장됨.
  // http://localhost:9090/team4/admin/prodcate/create.do
  @RequestMapping(value = "/admin/prodcate/create.do", method = RequestMethod.POST)
  public ModelAndView create(ProdcateVO prodcateVO) {
    ...
    mav.setViewName(
        "redirect:/admin/prodcate/create_msg.jsp?count=" + count + "&prodcategrpno=" + prodcateVO.getProdcategrpno());

    return mav;
  }

  // http://localhost:9090/ojt/admin/prodcate/list.do
  @RequestMapping(value = "/admin/prodcate/list.do", method = RequestMethod.GET)
  public ModelAndView list() {
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/admin/prodcate/list"); // /webapp/admin/prodcate/list.jsp
  ...
  // http://localhost:9090/ojt/admin/prodcate/list_by_prodcategrpno.do?prodcategrpno=1
  @RequestMapping(value = "/admin/prodcate/list_by_prodcategrpno.do", method = RequestMethod.GET)
  public ModelAndView list_by_prodcategrpno(int prodcategrpno) {
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/admin/prodcate/list_by_prodcategrpno"); // /webapp/admin/prodcate/list_by_prodcategrpno.jsp
  ...
  // JSON
  // http://localhost:9090/team4/admin/prodcate/read.do?prodcateno=1
  @ResponseBody
  @RequestMapping(value = "/admin/prodcate/read.do", method = RequestMethod.GET, produces = "text/plain;charset=UTF-8")
  ...
  // http://localhost:9090/ojt/admin/prodcate/update.do?prodcateno=1
  @RequestMapping(value = "/admin/prodcate/update.do", method = RequestMethod.GET)
  public ModelAndView update(int prodcateno) {
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/admin/prodcate/update"); // /webapp/admin/prodcate/update.jsp
  ...
  // prodcateVO는 Form 태그의 값으로 자동 저장됨.
  // http://localhost:9090/ojt/admin/prodcate/update.do
  @RequestMapping(value = "/admin/prodcate/update.do", method = RequestMethod.POST)
  public ModelAndView update(ProdcateVO prodcateVO, int viewno) {
    ...
    // mav.setViewName("redirect:/admin/prodcate/update_msg.jsp?count=" +
    // count+"&prodcate_title=" + prodcate_title +
    // "&prodcategrpno="+prodcateVO.getProdcategrpno());

    if (viewno == 1) {
      mav.setViewName("redirect:/admin/prodcate/update_msg.jsp?count=" + count + "&prodcate_title=" + prodcate_title
          + "&prodcategrpno=" + prodcateVO.getProdcategrpno());
    } else if (viewno == 2) {
      mav.setViewName("redirect:/admin/prodcate/list.do");
    }
    return mav;
  }

  // http://localhost:9090/ojt/admin/prodcate/delete.do?prodcateno=1
  @RequestMapping(value = "/admin/prodcate/delete.do", method = RequestMethod.GET)
  public ModelAndView delete(int prodcateno) {
    ModelAndView mav = new ModelAndView();
    // mav.setViewName("/admin/prodcate/delete"); // /webapp/admin/prodcate/delete.jsp
  ...
  // prodcateVO는 Form 태그의 값으로 자동 저장됨.
  // http://localhost:9090/ojt/admin/prodcate/delete.do
  @RequestMapping(value = "/admin/prodcate/delete.do", method = RequestMethod.POST)
  public ModelAndView delete_proc(int prodcateno, int viewno) {
    ...
    if (viewno == 1) {
      mav.setViewName("redirect:/admin/prodcate/delete_msg.jsp?count=" + count + "&prodgrp_title=" + prodgrp_title
   ...
   * @return
   */
  @RequestMapping(value = "/admin/prodcate/delete_product.do", method = RequestMethod.POST)
  ...
  /**
   * 결합된 카테고리 그룹별 카테고리 목록 http://localhost:9090/ojt/admin/prodcate/list_index_left.do
   * 
   * @param request
   * @return
   */
  @RequestMapping(value = "/admin/prodcate/list_index_left.do", method = RequestMethod.GET)
  public ModelAndView list_index_left(HttpServletRequest request) {
    // System.out.println("--> list_index() GET called.");
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/admin/prodcate/list_index_left"); // webapp/admin/prodcate/list_index_left.jsp
  ...
  // http://localhost:9090/ojt/admin/prodcate/update_seqno_up.do?prodcateno=29
  @RequestMapping(value = "/admin/prodcate/update_seqno_up.do", method = RequestMethod.POST)
  public ModelAndView update_seqno_up(int prodcateno, int viewno) {
    ...
    if (viewno == 1) {
      mav.setViewName(
          "redirect:/admin/prodcate/list_by_prodcategrpno.do?prodcategrpno=" + prodcategrp_ProdcateVO.getProdcategrpno());
    } else if (viewno == 2) {
      mav.setViewName("redirect:/admin/prodcate/list.do");
    }
    // mav.setViewName("redirect:/admin/prodcate/list.do"); // 전체 목록
    // ProdcateVO prodcateVO = prodcateProc.read(prodcateno); // 조인 없이 grp
    // mav.setViewName("redirect:/admin/prodcate/list_by_prodcategrpno.do?prodcategrpno="+prodcateVO.getProdcategrpno());
    // // 조인 없이 grp

    return mav;
  }

  // http://localhost:9090/ojt/admin/prodcate/update_seqno_down.do
  @RequestMapping(value = "/admin/prodcate/update_seqno_down.do", method = RequestMethod.POST)
  ...
  // http://localhost:9090/ojt/admin/prodcate/visible.do
  @RequestMapping(value = "/admin/prodcate/visible.do", method = RequestMethod.POST)
  ...
  // http://localhost:9090/ojt/admin/prodcate/nonvisible.do
  @RequestMapping(value = "/admin/prodcate/nonvisible.do", method = RequestMethod.POST)
