...
public interface ProdcategrpProcInter {
  /**
  ...
  /**
   * 등록된 글수 증가 <xmp> <update id="increase_prodgrp_cnt" parameterType="int"> </xmp>
   * 
   * @param prodcategrpno
   * @param prodgrp_cnt
   * @return 처리된 레코드 갯수
  ...
  /**
   * 등록된 글수 감소 <xmp> <update id="increase_prodgrp_cnt" parameterType="int"> </xmp>
   * 
   * @param prodcategrpno
   * @param prodgrp_cnt
   * @return 처리된 레코드 갯수
