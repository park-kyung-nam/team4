...
<DIV class='title_line' style='width: 100%;'>
   주문 수정 
</DIV>

<FORM name='frm' method='POST' action='./update_order.do'>
  <!-- 개발시 임시 값 사용: 1 -->
  <input type='hidden' name='orderno' id='orderno' value='${orderVO.orderno }'>

  <DIV id='read_send' style='float:left; width:50%; height: 50%;
  margin:20px auto; '>발송인 정보 <br><br>
 
<%-- 발송인 : ${orderVO.customerName }<br>    
연락처 : ${orderVO.phoneno }<br>
주문 시간 : ${orderVO.orderDate.substring(0, 10)} <br>  --%>
 ...
 <div id='order-box' style="width:100%; height:30%;">  
    <div class="form-group">  
      ...
      <div class="col-md-10"> 
        ...
        name='customerName' id='customerName' value='${orderVO.customerName }' required="required" 
        style='width: 50%;' placeholder="주문자 성함" autofocus="autofocus">   
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='phoneno' id='phoneno' 
                   value='${orderVO.phoneno }' required="required" style='width: 100%;' placeholder="전화번호">
      </div>
    </div>  
...
<DIV id='read_send' style='float:right; width:50%; height: 50%; padding-left:5px;
 border-left: solid 2px #AAAAAA; margin:20px auto; '>배송지 정보 <br><br>
...
상세 주소 : ${orderVO.orderAddr2 } <br>   --%>
 ...
 <div class="form-group"> 
      ...
      <div class="col-md-10"> 
        <input type='text' class="form-control input-md"  
        name='orderName' id='orderName' value='${orderVO.orderName }' required="required" 
        style='width: 50%;' placeholder="수취인 성함" autofocus="autofocus">   
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='zipCode' id='zipCode' 
                   value='${orderVO.zipCode }' required="required" style='width: 30%;' placeholder="우편번호">
      ...
      <div class="form-group"> 
      <label for="orderName" class="col-md-2 control-label">주소</label>    
      <div class="col-md-10"> 
        <input type='text' class="form-control input-md"  
        name='orderAddr1' id='orderAddr1' value='${orderVO.orderAddr1 }' required="required" 
        style='width: 100%;' placeholder="주소" autofocus="autofocus">   
      </div>
    </div>   
   
   <div class="form-group"> 
      <label for="orderName" class="col-md-2 control-label">상세주소</label>    
      <div class="col-md-10"> 
        <input type='text' class="form-control input-md"  
        name='orderAddr2' id='orderAddr2' value='${orderVO.orderAddr2 }' required="required" 
        style='width: 100%;' placeholder="상세주소" autofocus="autofocus">   
      </div>
    </div>   
...
<!-- ----- DAUM 우편번호 API 종료----- -->
     ...
     <div class="form-group">
      <div class="col-md-offset-2 col-md-10">
        <button type="submit" class="btn btn-primary btn-md" >주문 수정</button>
