...
<DIV class='content'>     
  ...
  <ASIDE style='float: right;'>
    ...
    <A href='./create.do?cateno=${categoryVO.cateno }'>등록</A>
  ...
  <FORM name='frm' method='POST' action='./update.do'
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-md" name='title' id='title' value='${serviceVO.title}' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
        <label for="content" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-md" name='contents' id='contents'  rows='10'>${serviceVO.contents}</textarea>
        </div>
      </div>
