...
<DIV class='title_line'>이벤트</DIV>

<DIV class='aside_menu'>
<!--   <ASIDE style='float: left;'><A href='../categrp/list.do'>카테고리 그룹</A></ASIDE>  -->
  <ASIDE style='float: right;'>
    <A href='./create.do'>이벤트 등록</A> <span class='menu_divide'> |</span>
...
<TABLE class='table table-striped'>
  ...
  <TR>
    <TD style='text-align: center ;'>${info.count }</TD>
     ...
     <td style='vertical-align: middle;'>              
    <a href="./read.do?eventno=${eventVO.eventno}">${eventVO.e_title }</a>
    </td>
    <td style='text-align: center ;'>${eventVO.rdate.substring(0, 10) }</td>
    <TD>
      <A href="./update.do?eventno=${eventVO.eventno }"><IMG src='./images/update.png' title='수정'></A>
      <A href='./delete.do?eventno=${eventVO.eventno }&nowPage=${param.nowPage }'><IMG src='./images/delete.png' title='삭제'></A>
    </TD>
  </TR>
  </c:forEach> 
  </tbody>
