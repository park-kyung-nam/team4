...
<FORM name='frm' method='POST' action='./reply.do'
   ...
   <!-- 테스트를 위하여 1번 지정        -->      
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='e_title' id='e_title' value='' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
        <label for="e_content" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='e_content' id='e_content'  rows='10'></textarea>
        </div>
         <div class="form-group">   
