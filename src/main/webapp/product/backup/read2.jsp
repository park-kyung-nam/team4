...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <ASIDE style='float: right;'>
    ...
    <span class='menu_divide' >│</span> 
    <A href='./reply.do?prodcateno=${prodcategrp_ProdcateVO.prodcateno }&productno=${productVO.productno }&nowPage=${param.nowPage }&viewno=${param.viewno }&customerno=${param.customerno}'>답변</A>
    <span class='menu_divide' >│</span> 
    <A href='./list_by_prodcateno_search_paging.do?prodcateno=${prodcategrp_ProdcateVO.prodcateno }&word=${param.word}&nowPage=${param.nowPage }&customerno=${param.customerno}'>목록</A>
    <span class='menu_divide' >│</span> 
    <A href='./update.do?prodcateno=${prodcategrp_ProdcateVO.prodcateno }&productno=${productVO.productno }&nowPage=${param.nowPage }&customerno=${param.customerno}'>수정</A>
    <span class='menu_divide' >│</span> 
    <A href='./delete.do?productno=${productVO.productno }&prodcateno=${prodcategrp_ProdcateVO.prodcateno }&nowPage=${param.nowPage }&customerno=${param.customerno}'>삭제</A>
  </ASIDE> 
  ...
  <FORM name='frm' method="get" action='./update.do'>
      <input type="hidden" name="productno" value="${productVO.productno}">
            ...
            <button type="button"><a href="#">바로구매하기</a></button>
