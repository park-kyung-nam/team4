...
<DIV class='message'>
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        <br>
        <button type='button' onclick="location.href='./create.do?prodcateno=${param.prodcateno}&nowPage=${param.nowPage }&viewno=${param.viewno }&customerno=${param.customerno }'">새로운 컨텐츠 등록</button>
