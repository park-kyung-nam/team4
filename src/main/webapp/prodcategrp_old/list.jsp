...
<DIV class='content' style='width: 90%;'>
  ...
  <DIV id='panel_update' style='display: none; padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_update' id='frm_update' method='POST' 
      ...
      <label for='title'>그룹 이름</label>
      <input type='text' name='title' id='title' size='15' value='' required="required" style='width: 30%;'>
...
<TABLE class='table table-striped'>
  ...
  <TR>
    <TD style='text-align: center ;'>${prodcategrpVO.seqno }</TD>
    <TD><A href='../cate/list_by_prodcategrpno.do?prodcategrpno=${prodcategrpVO.prodcategrpno }'>${prodcategrpVO.title }</A></TD>
    <TD style='text-align: center ;'>${prodcategrpVO.rdate.substring(0, 10) }</TD>
    <TD style='text-align: center ;'>
    <c:choose>
      <c:when test="${prodcategrpVO.visible == 'Y'}">
        <IMG src='./images/display_show.png'>
      </c:when>
      <c:when test="${prodcategrpVO.visible == 'N'}">
        <IMG src='./images/display_hide.png'>
      </c:when>
    </c:choose>
