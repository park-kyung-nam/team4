...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item" ><A href='./list_by_prodcategrpno.do?prodcategrpno=${param.prodcategrpno }'>${prodcategrpVO.prodgrp_title }</A> </li>
    <li class="breadcrumb-item active" aria-current="page"><A href='javascript:location.reload();'>카테고리 등록</A> </li>
  </ol>
  </nav>
  <!-- /페이지 위치 구간 종료 -->
  ...
  <h3>${prodcategrpVO.prodgrp_title }<span>에 새로운 카테고리 등록</span></h3>
...
<FORM name='frm' method='POST' action='./create.do'>
  ...
  <div class="form-row">
    <div class="form-group col">
      ...
      <input class="form-control" type='text' name='prodcate_title' id='title' value='' required="required" autofocus="autofocus">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-lg-6">
      <label for="seqno">출력 순서</label>
      <input class="form-control" type='number' name='prodcate_seqno' id='seqno' value='1' required="required" placeholder="${seqno }" min="1" max="1000">
    </div>
    <div class="form-group col-lg-6">
  ...
  <div class="form-row">
    <div class="form-group col">
      ...
      <input class="form-control" type='text' name='prodcate_ids' id='ids' value='admin' required="required">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-lg-6">
