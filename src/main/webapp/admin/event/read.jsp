...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <ASIDE style='float: left;'>
    <A href='./list_by_search_paging.do'> 이벤트</A> 
  </ASIDE>
  <ASIDE style='float: right;'>
    ...
    <span class='menu_divide' >│</span> 
    <A href='./reply.do?eventno=${eventVO.eventno }'>답변</A>
    <span class='menu_divide' >│</span> 
    <A href='./list_by_search_paging.do'>목록</A>
    <span class='menu_divide' >│</span> 
    <A href='./update.do?eventno=${eventVO.eventno }&nowPage=${param.nowPage }'>수정</A>
    <span class='menu_divide' >│</span> 
    <A href='./delete.do?eventno=${eventVO.eventno }&nowPage=${param.nowPage }'>삭제</A>
  </ASIDE> 
      ...
      <fieldset class="fieldset">
        <ul>
          ...
          <DIV>
            ...
            <span>${eventVO.e_title}</span><br><br>
            <span>${eventVO.e_content}</span>
            <li class="li_none">
