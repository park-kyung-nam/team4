...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:location.reload();">카테고리</a></li>
  </ol>
  </nav>
    ...
    <FORM class="form" name='frm' method='POST' action='./create.do' 
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" name='title' id='title' class="form-control" placeholder="" aria-label="title" aria-describedby="basic-addon1">
    </div>
    
    <div class="form-group mb-3">
      <input type="text" data-role="tagsinput" name='word' id='word' class="form-control" placeholder="태그" aria-label="mainurl" aria-describedby="basic-addon1">
    </div>
    ...
    <div class="input-group date mb-3">
      ...
      <input type="text" name="ddate" value="${customerVO.bdate.substring(0,10) }" class="form-control">
    </div>
    <script type="text/javascript">
    // var date = '${customerVO.ddate }';
    ...
    <div class="mx-auto mb-3">
      <textarea class="form-control input-lg" name='content' id='content' rows='50' cols='70'></textarea>
    </div>
    
    
    <input class='form_input' type='hidden' name='adminno' id='adminno' value='${sessionScope.adminno }' required>
