...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:location.reload();">관리자 추가</a></li>
  </ol>
  </nav>
  ...
  <div class="alert alert-dismissible fade show  ${al_class }" role="alert">
   ...
   <form name="frm" id="frm" method='POST' action='./create.do' 
    ...
    <div class="d-flex">
    <h3 class="flex-grow-1">관리자 추가</h3>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="chino.gif" name="profileimg" id="profileimg" aria-describedby="profileimg" placeholder="/chino.gif">
    </div>
    <div class="form-group">
      <label for="name">이름*</label>
      <input type="text" class="form-control" name="name" id="name" aria-describedby="name" placeholder="홍길동">
    </div>
    <div class="form-group">
      <label for="id">아이디*</label>
      <input type="text" class="form-control" name="id" id="id" aria-describedby="name" placeholder="gildong">
    </div>
    <div class="form-group">
      <label for="email">이메일*</label>
      <input type="email" class="form-control" name="email" id="email" aria-describedby="name" placeholder="gildong@naver.com">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" name="passwd2" id="passwd2" aria-describedby="name" placeholder="********">
    </div>
    
    <div class="form-group">
      <label for="address">주소*</label>
      <input type="text" class="form-control" name="address" id="address" aria-describedby="name" placeholder="한양">
    </div>
    <div class="form-group">
      <label for="phone1">전화번호*</label>
      <input type="text" class="form-control" name="phone1" id="phone1" aria-describedby="name" placeholder="01012345678">
    </div>
    <div class="form-group">
      <label for="phone2">전화번호2</label>
      <input type="text" class="form-control" name="phone2" id="phone2" aria-describedby="name" placeholder="">
    </div>
