...
<div class="row">
  <div class="mx-auto text-center">
      <h2 class="h2 font-weight-light">가입을 축하드립니다!</h2>
      <h5 class="font-weight-light">이제 상품을 살펴보세요!</h5><br>
      <a href="${pageContext.request.contextPath}" class="btn btn-primary btn-lg">홈으로</a><br>
      <br>
      <img src="${pageContext.request.contextPath}/customer/richer_yukata_kyaa.png">
  </div>
</div>
</div>
