...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <div class="alert alert-dismissible fade show  ${al_class }" role="alert">
   ...
   <form name="frm" id="frm" method='POST' action='./update_passwd.do' 
    ...
    <button type="submit" class="btn btn-info ml-1">변경</button>
    </div>
    <br>
    
    <div class="form-group">
      <label for="passwd_old">현재 비밀번호*</label>
      <input type="password" class="form-control" name="passwd_old" id="passwd_old" aria-describedby="name" placeholder="********">
    </div>
