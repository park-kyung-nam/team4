...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:location.reload();">자세히 보기</a></li>
  </ol>
  </nav>
  ...
  <div class="alert alert-dismissible fade show  ${al_class }" role="alert">
    ...
    <div class="d-flex">
    <h3 class="flex-grow-1">자세히 보기</h3>
    <button type="button" onclick="location.href='./update.do?logno=${alog.logno}'"class="btn btn-info ml-1">수정</button>
    </div>
    <br>
 
    <div class="card alert-primary">
    <div class="card-body">
    <h5 class="card-title">#${alog.logno}</h5>
    
    <p class="card-text alert-link"> 분류 : ${alog.logtype}</p>
    <p class="card-text"> 등록자 : ${alog.adminno}</p>
    <p class="card-text"> 등록된 아이피 : ${alog.ipv4}</p>
    <p class="card-text"> 등록된 날짜 : ${alog.logdate}</p>
    <hr>
    <p class="card-text">${alog.logdesc}</p>
