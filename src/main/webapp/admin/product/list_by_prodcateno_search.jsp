...
<div class="content-wrapper flex-fill px-2 pr-md-4">
  ...
  <form name='frm' id='frm' method="get" action="./list_by_prodcateno_search.do">
  ...
  <ASIDE style='float: right;'>
    ...
    <button type='button' 
                 onclick="location.href='./list_by_prodcateno_search.do?prodcateno=${prodcategrp_ProdcateVO.prodcateno }'">전체 보기</button>
  </ASIDE>
  </form>
      ...
      <tbody>
        <c:forEach var="productVO" items="${list }">
          <tr> 
            ...
            <td style='vertical-align: middle;'>
              <a href="./read.do?productno=${productVO.productno}&prodcateno=${productVO.prodcateno}&word=${param.word}">${productVO.prod_title}</a> 
            </td> 
