    ...
    <UL>
      <c:choose>
        <c:when test="${param.count > 0 }">
         ...
         <button type='button' onclick="location.href='../product/delete.do?prodcateno=${param.prodcateno}&productno=${param.productno}&nowPage=${param.nowPage}&prod_word=${param.prod_word}&viewno=${param.viewno}&customerno=${param.customerno }'">제품 삭제</button>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='../product/list_by_prodcateno_search_paging.do?prodcateno=${param.prodcateno}&viewno=${param.viewno}&nowPage=${param.nowPage}&prod_word=${param.prod_word}&customerno=${param.customerno }'">목록</button>
      </LI>
