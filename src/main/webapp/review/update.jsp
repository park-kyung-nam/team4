...
<DIV class='title_line' style='width: 40%;'>리뷰 수정</DIV>
...
<FORM name='frm' method='POST' action='./update.do'
   ...
   <!-- 테스트를 위하여 1번 지정 -->        
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='r_title' id='r_title' value='${reviewVO.r_title}' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
        <label for="r_content" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='r_content' id='r_content'  rows='10'>${reviewVO.r_content}</textarea>
        </div>
      </div>
      <div class="form-group">   
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
        <input type='text'  class="form-control input-lg" name='rname' id='rname' value='${reviewVO.rname }' size='10'>
