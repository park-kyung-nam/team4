...
<DIV class='title_line' style='width: 50%;'>등록</DIV>

<FORM name='frm' method='POST' action='./create.do'>
  <!-- 개발시 임시 값 사용: 1 -->
  <input type='hidden' name='delivery_no' id='delivery_no' value='${param.delivery_no }'>
  ...
  <DIV class='content' style='width: 100%;'>
    <FORM name='frm' method='POST' action='./create.do'
      ...
      <div class="form-group">   
        <label for="title" class="col-md-1 control-label">수령인</label>
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='recipient' id='recipient' value='장재형' required="required" style='width: 80%;'>
        </div>
      </div>   
     ...
     <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='phone' id='phone' 
                   value='010-0000-0000' required="required" style='width: 50%;' placeholder="전화번호"> 예) 010-0000-0000
      </div>
    </div>  
