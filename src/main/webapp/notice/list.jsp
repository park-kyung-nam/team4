...
<!--   <ASIDE style='float: left;'><A href='../categrp/list.do'>카테고리 그룹</A></ASIDE>  -->
  <ASIDE style='float: right;'>
    <A href='./create.do'>공지사항 등록</A> <span class='menu_divide'> |</span>
...
<TABLE class='table table-striped'>
  ...
  <TR>
    ...
    <td>
    <a href="./read.do?noticeno=${noticeVO.noticeno}">${noticeVO.n_title }</a>
    </td>
    <TD style='text-align: center ;'>${noticeVO.rdate.substring(0, 10) }</TD>
    <TD>
      <A href="./update.do?noticeno=${noticeVO.noticeno }"><IMG src='./images/update.png' title='수정'></A>
      <A href='./delete.do?noticeno=${noticeVO.noticeno }&nowPage=${param.nowPage }'><IMG src='./images/delete.png' title='삭제'></A>
    </TD>
  </TR>
  </c:forEach> 
  </tbody>
