...
<jsp:include page="/menu/top_index.jsp" flush='false' />
  ...
  <div id="home_recommended" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
      <li data-target="#home_recommended" data-slide-to="0" class="active"></li>
      <li data-target="#home_recommended" data-slide-to="1"></li>
      <li data-target="#home_recommended" data-slide-to="2"></li>
    </ol>
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./kori_demo/home_demo1.png" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="./kori_demo/home_demo2.png" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="./kori_demo/home_demo3.png" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
    ...
    <a class="carousel-control-prev" href="#home_recommended" role="button" data-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#home_recommended" role="button" data-slide="next">
